...
charts
  ...
  Nous pouvons supposer que si un artiste n’est présent qu’une seule
...
1. **Ensemble de données 2022** : Contient des informations sur les noms des chansons, les artistes, le classement maximal, les semaines dans le chart, et diverses caractéristiques musicales, y compris la danceability, l'énergie, la sonorité, le discours, et plus encore.
2. **Ensemble de données 2023** : Comprend les noms des chansons, les artistes, les dates de sortie, le nombre de streams, et des caractéristiques musicales similaires, avec la danceability représentée en pourcentage.
...
- **Données de 2023** : Il n'y a pas de corrélation significative entre la danceability et le nombre de streams. La danceability seule ne prédit pas le succès des streams.
- **Données de 2022** : Il y a une légère tendance suggérant que des chansons plus dansantes peuvent obtenir de meilleurs classements, mais la corrélation est faible.

En général, bien que la danceability puisse influencer le succès d'une chanson dans une certaine mesure, il est clair qu'elle n'est pas le seul facteur. Une analyse complète devrait considérer plusieurs attributs musicaux et peut-être des facteurs externes comme les efforts de marketing et l'influence des médias sociaux.
...
- **Danceability et Streams** : Il n'y a pas de corrélation marquée entre la danceability et les streams. Cela confirme notre analyse précédente, indiquant que la danceability n'est pas un facteur déterminant du nombre de streams.
- **Energy et Valence** : Une corrélation positive notable entre l'énergie et la valence, suggérant que les chansons énergiques tendent à être perçues comme plus positives.
- **Instrumentalness et Acousticness** : Une forte corrélation positive, ce qui est attendu puisque les chansons avec une instrumentalité élevée ont souvent un caractère acoustique prononcé.

#### Heatmap des Corrélations (2022)

- **Danceability et Classement** : La danceability montre une faible corrélation positive avec le classement, ce qui est cohérent avec notre analyse antérieure des données de 2022.
- **Energy et Acousticness** : Une corrélation négative entre l'énergie et l'acousticness, indiquant que les chansons énergiques sont souvent moins acoustiques.
- **Speechiness et Classement** : Une légère corrélation négative entre la speechiness et le classement, suggérant que les chansons avec plus de paroles parlées tendent à avoir des classements inférieurs.
