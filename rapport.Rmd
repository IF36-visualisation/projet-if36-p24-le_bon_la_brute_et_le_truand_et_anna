...
ggplot(bpm_counts, aes(x = bpm_interval, y = n)) +
  geom_bar(stat = "identity") +
  scale_x_discrete(labels = c("0-50", "51-100", "101-150", "151-200", "201-250")) +
  labs(x = "Intervalles de BPM", y = "Nombre de chansons", title = "Répartition des BPM des 1000 premières chansons populaires") + theme_minimal()
...
# Comparer les caractéristiques audio des chansons populaires entre les saisons
