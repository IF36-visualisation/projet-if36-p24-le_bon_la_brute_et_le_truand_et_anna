...
artist_counts <- spotify_name23 %>%
  ...
  filter(n > 1)  # Étape 2: Filtrer les artistes apparaissant plus d'une fois

# Étape 3: Créer un graphique à barres
ggplot(artist_counts, aes(x = reorder(`artist(s)_name`, n), y = n)) +
  geom_bar(stat = "identity", fill = "steelblue") +
  coord_flip() +  # Retourner le graphique pour une meilleure lisibilité
  labs(title = "Nombre de fois que chaque artiste apparait plus d'une fois dans le dataset",
       x = "Artiste",
