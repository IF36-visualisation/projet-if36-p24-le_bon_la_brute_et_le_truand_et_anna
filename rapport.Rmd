...
# Normalize speechiness and instrumentalness
...
plot_data <- best_songs %>%
  ...
  pivot_longer(cols = c(instrumentalness_pct, speechiness_pct), names_to = "attribute", values_to = "value")

# Rename attributes for better readability
plot_data <- plot_data %>%
