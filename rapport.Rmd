...
- **Attribut** : `track_name`
  ...
  - **Explication** : Nom de la chanson. Utile pour l'identification et la recherche de la chanson dans les bases de données et les plateformes de streaming.
- **Attribut** : `artist(s)_name`
  - **Type de données** : chaîne de caractères
  - **Explication** : Nom de l'artiste(s) de la chanson. Permet d'analyser la popularité et le style de l'artiste associé à la chanson.
- **Attribut** : `artist_count`
  - **Type de données** : entier
  - **Explication** : Nombre d'artistes participants sur le titre. Peut indiquer des collaborations et des influences multiples sur la chanson.
- **Attribut** : `released_year`
  - **Type de données** : entier
  - **Explication** : L'année de sortie de la chanson. Permet d'étudier les tendances musicales au fil du temps et de comparer la performance des chansons dans différentes périodes.
- **Attribut** : `released_month`
  - **Type de données** : entier
  - **Explication** : Le mois de sortie de la chanson. Peut être utilisé pour analyser les saisonsnalités et les tendances saisonnières dans la musique.
- **Attribut** : `released_day`
  - **Type de données** : entier
  - **Explication** : Le jour de sortie de la chanson. Peut être pertinent pour étudier les stratégies de lancement de chansons.
- **Attribut** : `in_spotify_playlists`
  - **Type de données** : entier
  - **Explication** : Nombre de playlists Spotify dans lesquelles la chanson est présente. Indique la popularité et la portée de la chanson sur la plateforme Spotify.
- **Attribut** : `in_spotify_charts`
  - **Type de données** : entier
  - **Explication** : Nombre de fois où la chanson est apparue dans les classements Spotify. Révèle la popularité et la tendance de la chanson sur Spotify.
- **Attribut** : `streams`
  - **Type de données** : entier
  - **Explication** : Nombre de streams sur Spotify. Mesure la popularité et l'engagement des auditeurs avec la chanson sur Spotify.
- **Attribut** : `in_apple_playlists`
  - **Type de données** : entier
  - **Explication** : Nombre de playlists Apple Music dans lesquelles la chanson est présente. Indique la popularité de la chanson sur Apple Music.
- **Attribut** : `in_apple_charts`
  - **Type de données** : entier
  - **Explication** : Nombre de fois où la chanson est apparue dans les classements Apple Music. Révèle la popularité et la tendance de la chanson sur Apple Music.
- **Attribut** : `in_deezer_playlists`
  - **Type de données** : entier
  - **Explication** : Nombre de playlists Deezer dans lesquelles la chanson est présente. Indique la popularité de la chanson sur Deezer.
- **Attribut** : `in_deezer_charts`
  - **Type de données** : entier
  - **Explication** : Nombre de fois où la chanson est apparue dans les classements Deezer. Révèle la popularité et la tendance de la chanson sur Deezer.
- **Attribut** : `in_shazam_charts`
  - **Type de données** : entier
  - **Explication** : Nombre de fois où la chanson est apparue dans les classements Shazam. Peut indiquer la popularité émergente de la chanson.
- **Attribut** : `bpm`
  - **Type de données** : entier
  - **Explication** : Le nombre de battements par minute de la chanson, indiquant le tempo. Permet de classifier le style et le genre de la chanson.
- **Attribut** : `key`
  - **Type de données** : chaîne de caractères
  - **Explication** : La clé musicale dans laquelle la chanson est jouée. Utile pour l'analyse harmonique et la comparaison avec d'autres chansons.
- **Attribut** : `mode`
  - **Type de données** : chaîne de caractères
  - **Explication** : Le mode musical de la chanson, majeur ou mineur. Influence l'émotion et l'atmosphère perçue de la chanson.
- **Attribut** : `danceability_%`
  - **Type de données** : entier
  - **Explication** : Pourcentage indiquant à quel point une chanson est adaptée à la danse. Utile pour comprendre l'aspect rythmique et l'attrait pour la danse.
- **Attribut** : `valence_%`
  - **Type de données** : entier
  - **Explication** : Pourcentage reflétant la positivité transmise par la chanson. Peut être utilisé pour analyser le sentiment et l'humeur de la chanson.
- **Attribut** : `energy_%`
  - **Type de données** : entier
  - **Explication** : Pourcentage mesurant l'intensité et l'activité de la chanson. Indique le niveau d'énergie perçu de la chanson.
- **Attribut** : `acousticness_%`
  - **Type de données** : entier
  - **Explication** : Pourcentage indiquant à quel point une chanson est acoustique. Utile pour distinguer les enregistrements acoustiques des enregistrements électroniques.
- **Attribut** : `instrumentalness_%`
  - **Type de données** : entier
  - **Explication** : Pourcentage estimant la quantité de la chanson qui est instrumentale. Peut aider à identifier les chansons avec peu ou pas de voix.
- **Attribut** : `liveness_%`
  - **Type de données** : entier
  - **Explication** : Pourcentage détectant la présence d'un public dans l'enregistrement. Indique si la chanson a été enregistrée en direct ou en studio.
- **Attribut** : `speechiness_%`
  - **Type de données** : entier
  - **Explication** : Pourcentage qui identifie la présence de paroles parlées dans une chanson. Utile pour distinguer les chansons chantées des chansons parlées.
...
- **Attribut** : `weeks_on_chart`
  - **Type de données** : Entier
  - **Explication** : Nombre de semaines dans les classements des meilleurs sons.

- **Attribut** : `danceability`
  - **Type de données** : Réel
  - **Explication** : La danseabilité décrit à quel point une piste est adaptée à la danse en fonction d'une combinaison d'éléments musicaux comprenant le tempo, la stabilité du rythme, la force du rythme et la régularité globale. Une valeur de 0.0 est la moins adaptée à la danse et 1.0 est la plus adaptée.

- **Attribut** : `energy`
  - **Type de données** : Réel
  - **Explication** : L'énergie est une mesure de 0.0 à 1.0 et représente une mesure perceptive de l'intensité et de l'activité.

- **Attribut** : `key`
  - **Type de données** : Entier
  - **Explication** : La tonalité dans laquelle la piste se trouve. Les entiers sont associés aux notes en utilisant la notation standard des classes de hauteur.

- **Attribut** : `loudness`
  - **Type de données** : Réel
  - **Explication** : La loudness est la qualité d’un son qui est corrélée avec l’amplitude. Les valeurs se situent généralement entre -60 et 0 dB.

- **Attribut** : `mode`
  - **Type de données** : Entier
  - **Explication** : Le mode indique la modalité (majeure ou mineure) d'une piste, le type de gamme à partir de laquelle son contenu mélodique est dérivé. La majeure est représentée par 1 et la mineure par 0.

- **Attribut** : `speechiness`
  - **Type de données** : Réel
  - **Explication** : La parole détecte la présence de mots parlés dans une piste. Plus la valeur est proche de 1.0, plus l’enregistrement est parlé.

- **Attribut** : `acousticness`
  - **Type de données** : Réel
  - **Explication** : Une mesure de confiance de 0.0 à 1.0 quant à savoir si la piste est acoustique.

- **Attribut** : `instrumentalness`
  - **Type de données** : Réel
  - **Explication** : Détecte la place de l’instrumental dans un son. Plus la valeur est proche de 1.0, plus le son est considéré comme instrumental (moins il y a de contenu vocal).

- **Attribut** : `liveness`
  - **Type de données** : Réel
  - **Explication** : Détecte la présence d'un public dans l'enregistrement.

- **Attribut** : `tempo`
  - **Type de données** : Réel
  - **Explication** : Le tempo estimé global d'une piste en battements par minute (BPM).

- **Attribut** : `time_signature`
  - **Type de données** : Entier
  - **Explication** : La signature temporelle (ou mesure) est une convention de notation qui spécifie combien de temps (ou battements) il y a dans chaque mesure.
...
des auditeurs tout au long de l'année.
